 ...
 */
- (void) sendStatement:(TCStatement *)statementToSend withCompletionBlock:(void (^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
 ...
 */
- (void) sendStatements:(TCStatementCollection *)statementArray withCompletionBlock:(void(^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
    // NSLog(@"%@", NSStringFromClass([_recordStore class]));
    TCLRS *lrs = [[TCLRS alloc] initWithOptions:[_recordStore objectAtIndex:0]];
...
/**
 ...
 @param {Function} [cfg.callback] Function to run with state
 */
- (void) setStateWithValue:(NSDictionary *)value withStateId:(NSString *)stateId withActivityId:(NSString *)activityId withAgent:(TCAgent *)agent withRegistration:(NSString *)registration withOptions:(NSDictionary *)options withCompletionBlock:(void(^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
    TCLRS *lrs = [[TCLRS alloc] initWithOptions:[_recordStore objectAtIndex:0]];
...
/**
 ...
 @param {Function} [cfg.callback] Function to run with state
 */
- (void) deleteStateWithStateId:(NSString *)stateId withActivityId:(NSString *)activityId withAgent:(TCAgent *)agent withRegistration:(NSString *)registration withOptions:(NSDictionary *)options withCompletionBlock:(void(^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
    TCLRS *lrs = [[TCLRS alloc] initWithOptions:[_recordStore objectAtIndex:0]];
...
/**
 ...
 @param {Function} [cfg.callback] Function to run with activity profile
 */
- (void) setActivityProfile:(NSString *)key withValue:(NSDictionary *)value withOptions:(NSDictionary *)options withCompletionBlock:(void(^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
    dispatch_async(dispatch_get_main_queue(), ^{
        TCError *error = [[TCError alloc] initWithMessage:@"Not Implemented"];
        errorBlock(error);
...
/**
 ...
 @param {Function} [cfg.callback] Function to run with activity profile
 */
- (void) deleteActivityProfile:(NSString *)key withOptions:(NSDictionary *)options withCompletionBlock:(void(^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
    dispatch_async(dispatch_get_main_queue(), ^{
        TCError *error = [[TCError alloc] initWithMessage:@"Not Implemented"];
        errorBlock(error);
