 ...
 */
- (void) saveStatement:(TCStatement *)statement withOptions:(NSDictionary *)options withCompletionBlock:(void (^)(void))completionBlock  withErrorBlock:(void(^)(TCError *))errorBlock
{
...
/**
 ...
 @param {Function} [cfg.callback] Callback to execute on completion
 */
- (void) saveStatements:(TCStatementCollection *)statementArray withOptions:(NSDictionary *)options withCompletionBlock:(void (^)(void))completionBlock  withErrorBlock:(void(^)(TCError *))errorBlock
{
...
/**
 ...
 @param {Function} [cfg.callback] Callback to execute on completion
 */
- (void) dropStateWithStateId:(NSString *)stateId withActivityId:(NSString *)activityId withAgent:(TCAgent *)agent withRegistration:(NSString *)registration withOptions:(NSDictionary *)options withCompletionBlock:(void (^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
    TCState *state = [[TCState alloc] initWithContents:nil withStateId:stateId withActivityId:activityId withAgent:agent withRegistration:registration];
 ...
 */
- (void) retrieveActivityProfileWithKey:(NSString *)key withActivity:(TCActivity *)activity withOptions:(NSDictionary *)options withCompletionBlock:(void (^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
...
/**
 ...
 @param {Function} [cfg.callback] Callback to execute on completion
 */
- (void) saveActivityProfileWithValue:(NSDictionary *)profile forKey:(NSString *)key withOptions:(NSDictionary *)options withCompletionBlock:(void (^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
...
/**
 ...
 @param {Function} [cfg.callback] Callback to execute on completion
 */
- (void) dropActivityProfileWithKey:(NSString *)key withActivity:(TCActivity *)activity withOptions:(NSDictionary *)options withCompletionBlock:(void (^)(void))completionBlock withErrorBlock:(void(^)(TCError *))errorBlock
{
